...
from .views import CategoryView, CategoryListView, ProductView, DetailView, ImageListView, SidedishListView, FlavorListView, BreweryView, ProductListView, OrderView
